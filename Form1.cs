...
namespace BatchFileRenamer
{
    public partial class Form1 : LocalizedForm
    {
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            ...
            DialogResult res = MessageBox.Show(listBoxFiles.Items.Count + itemType + getLocStr(Properties.Settings.Default.language,"rename_sure"), getLocStr(Properties.Settings.Default.language, "rename_sure_title"), MessageBoxButtons.YesNo);
